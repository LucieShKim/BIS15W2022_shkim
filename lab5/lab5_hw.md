...
```r
good_b<-filter(good_guys,hair_color=="No Hair")
dim(good_b)
```
...
```r
bad_b<-filter(bad_guys,hair_color=="No Hair")
dim(bad_b)
```
...
##  9 Giga~ Female green     <NA>  Red          62.5 DC Comics <NA>       bad      
## 10 Hulk  Male   green     Huma~ Green       244   Marvel C~ green      good     
## # ... with 18 more rows, and 1 more variable: weight <dbl>
```

12. ...and the superheros over 450 in weight. Bonus question! Why do we not have 16 rows in question #10?
#because they contain who over 250 in height but less 400 in weight too
...
```r
filter(superhero_powers,hero_names=="Wonder Woman")
```
