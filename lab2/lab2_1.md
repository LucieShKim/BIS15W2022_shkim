...
```r
my_int <- as.integer(my_numeric) #create a new object specified as an integer
```


```r
is.numeric(my_int) #is my_numeric an integer?
```
...
if I have NA in mt date, I can find it by using is.na()
