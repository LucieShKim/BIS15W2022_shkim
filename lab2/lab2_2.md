...
```r
newrow<-c(100,200,300)
all_harry_potter_matrix<-rbind(all_harry_potter_matrix,newrow)
all_harry_potter_matrix
```
...
```r
harry_potter_matrix[3:8]
```

```
## [1] 249.5 290.0 292.0 301.9 295.9 381.0
```
