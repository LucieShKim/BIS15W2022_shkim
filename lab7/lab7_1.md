...
##  1 Aves  Accipitri~ Accip~ Acci~ albogu~       -999 Pied Gosha~            -999 
##  2 Aves  Accipitri~ Accip~ Acci~ badius        -999 Shikra                  363.
##  3 Aves  Accipitri~ Accip~ Acci~ bicolor       -999 Bicolored ~            -999 
##  4 Aves  Accipitri~ Accip~ Acci~ brachy~       -999 New Britai~            -999 
##  5 Aves  Accipitri~ Accip~ Acci~ brevip~       -999 Levant Spa~             363.
##  6 Aves  Accipitri~ Accip~ Acci~ castan~       -999 Chestnut-f~            -999 
##  7 Aves  Accipitri~ Accip~ Acci~ chilen~       -999 Chilean Ha~            -999 
##  8 Aves  Accipitri~ Accip~ Acci~ chiono~       -999 White-brea~             548.
##  9 Aves  Accipitri~ Accip~ Acci~ cirroc~       -999 Collared S~            -999 
## 10 Aves  Accipitri~ Accip~ Acci~ cooper~       -999 Cooper's H~             730 
...
```r
hist(amniota$female_body_mass_g)
```

![](lab7_1_files/figure-html/unnamed-chunk-19-1.png)<!-- -->
...
we need to find and delete -999 instead of NA
...
```r
life_history_v2<-readr::read_csv("data/mammal_lifehistories_v2.csv")
```
...
```r
life_history_prac<-life_history_v2%>%
  na_if("-999")
```
...
```r
life_history_prac%>%
  summarise(total_nas=sum(is.na(life_history_prac)))
```
