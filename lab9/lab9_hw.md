...
```r
colleges<-select_all(colleges,tolower)
colleges
```
...
```
## `summarise()` has grouped output by 'city'. You can override using the `.groups`
## argument.
```
...
as increasing admissions rate, decreasing 4year completion rate
