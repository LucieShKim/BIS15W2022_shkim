...
```r
hbirds$neighborhood<-c("lake","brent", "lake", "scenic")
```
...
##      sex length_in weight_oz neighborhood
## 1   Male       3.2       2.9         lake
## 2 Female       3.7         4        brent
## 3   Male       3.4       3.1         lake
## 4 Female       3.6       3.9       scenic
```
...
```
## [1] "C:/bis15folder/BIS15W2022_shkim/lab3"
```
...
```r
write.csv(hsprings,"hsprings_sh.cvs",row.names=FALSE)
```
